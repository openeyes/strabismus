	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
	            ...
	            array('label'=>'Manage Datasets', 'url'=>array('/dataset/'), 'visible'=>!Yii::app()->user->isGuest),
	            array('label'=>'Admin Datasets', 'url'=>array('/dataset/admin'), 'visible'=>false),
	            array('label'=>'Create Dataset', 'url'=>array('/dataset/create'), 'visible'=>!Yii::app()->user->isGuest),
	            array('label'=>'Quick Create', 'url'=>array('/dataset/quick'), 'visible'=>!Yii::app()->user->isGuest),
